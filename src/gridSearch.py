...
def metrics_for_basic_queries():
    queries = [
        ...
        "I created Properties file for using in tests. how can I read specific property from My Properties file",
...
if __name__ == "__main__":
    metrics = metrics_for_basic_queries()
    metrics.to_csv("config metrics/metrics.csv")

    best_configs = analyze_best_config(metrics)
    best_configs.to_csv("config metrics/best_configs.csv")

    filtered_df = best_configs[best_configs['Num of Documents'] >= MIN_DOCUMENTS]
